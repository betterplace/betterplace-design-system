...
Avoid [using preprocessors’ parent scope operators (like Sass ampersand) to concatenate classnames](https://css-tricks.com/the-sass-ampersand/#aa-modifying-the-ampersand):
...
The reason for this rule is that splitting and “crafting” classnames can make it difficult to find
all usages of a certain class in code—which we want to avoid.
