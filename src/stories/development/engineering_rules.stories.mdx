...
🚧 This is where we note down our agreements and rules as a developers team. So far, this is
...
3. **Because we can. And we ❤️ CSS.** We are confident enough to write our stylesheets on our own.
   ...
   of a 3rd-party framework. It’s a great technology that we’ve grown up with. It’s a language we
   love.

### CSS methodologies

Not using a 3rd-party framework does not mean completely re-inventing the wheel. We are eager to
learn what the community knows and to build upon great ideas that others have come up with.
...
- We manage component-specific styles within the component code scope using
...
Avoid [using preprocessors’ parent scope operators (like Sass ampersand) to concatenate
classnames](https://css-tricks.com/the-sass-ampersand/#aa-modifying-the-ampersand):
