...
- Keyboard navigation has to be enabled manually on MacOS: https://support.apple.com/en-lb/guide/mac-help/mchlp1399/mac
...
As NVDA only runs on Windows, but we use Macs at betterplace, we have to either set up a virtual machine or use a service similar to BrowserStack or [AssistivLabs](https://assistivlabs.com/pricing).
